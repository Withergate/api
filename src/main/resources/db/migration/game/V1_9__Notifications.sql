...
INSERT INTO placeholder_texts(code, lang, text) VALUES
    ...
    ('detail.trait.training', 'en', '{} gained bonus experience thanks to the trait: [].'),
    ('detail.trait.training', 'cs', '{} dostal/a zkušenosti navíc díky schopnosti: [].'),
    ...
    ('detail.weapon.sanction.camo', 'en', 'Character increased encounter chance thanks to: [].'),
    ('detail.weapon.sanction.camo', 'cs', 'Postava zvýšila pravděpodobnost náhodné údálosti díky: [].'),
    ...
    ('detail.disaster.research.loss', 'en', 'You lost progress for your uncompleted research [] as a result of the disaster.'),
    ('detail.disaster.research.loss', 'cs', 'V důsledku pohromy tvůj klan přišel o rozpracovaný výzkum [].'),
