...
INSERT INTO research_details(identifier, bonus_type, bonus_text, value, information_level, cost, fame, image_url) VALUES
    ...
    ('CULTIVATION', 'REST_FOOD', 'detail.research.cultivation', 2, 0, 20, 1, 'https://storage.googleapis.com/withergate-images/research/cultivation.png'),
    ('ARCHITECTURE', 'BUILDING_FAME', 'detail.research.architecture', 2, 1, 30, 2, 'https://storage.googleapis.com/withergate-images/research/architecture.png'),
