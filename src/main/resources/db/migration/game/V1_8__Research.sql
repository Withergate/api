...
INSERT INTO localized_texts(research_info, lang, text) VALUES
    ...
    ('INDEPENDENCE', 'en', 'Your clan will receive bonus fame every turn during which you are not a member of any faction.'),
    ('INDEPENDENCE', 'cs', 'Tvůj klan obdrží slávu navíc každé kolo, během kterého není členem žádné frakce.'),
